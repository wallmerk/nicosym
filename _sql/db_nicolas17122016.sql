...
--
-- Client :  127.0.0.1
-- Généré le :  Sam 17 Décembre 2016 à 13:16
...
(1, NULL, 4, 1, 7, 2, 'Château brane-cantenac', 900, 850.7, 0, 75, 'Margaux<br /><br /><br />\r\n2ème cru Classé<br /><br /><br />\r\nRouge |12,5°', 'chateau-brane-cantenac', '2006', 1, 'Prêt à boire', '35', 0, 'Bordeaux  supérieur', 8, 9, 7, 8, 'Bouqueté, corsé  et à point j', 'Robe brique sombre,  nez bouqueté de fruits noirs …', 'Robe pourpre', 'cabernet sauvignon merlot  cabernet frais', 2),
(2, NULL, 3, 1, 3, 5, 'Jack', 1000, 950, 600, 50, '<p>azefazrga gareg aer</p>', 'jack', '1886', 1, 'Prêt à boire', '10', 1, '', 8, 9, 7, 8, 'azef eabzefv avzerg ', '<p>zaef azgezrg zdverg a</p>', 'Robe pourpre', 'cabernet sauvignon merlot  cabernet frais', 1);
...
(3, 'Crustacés', 'crustaces', '<p>TEST</p>', '4759993dd370402bf0212a7af4ea6953.png');
...
--
-- Contenu de la table `product_brand`
--

INSERT INTO `product_brand` (`id`, `label`, `is_active`, `ordre`, `slug`, `logo`) VALUES
(1, 'Château margaux', 1, '1', 'chateau-margaux', '01bd5102fbab83a8569c2d7fd0f76d83.png'),
(2, 'Château de meursault', 1, '2', 'chateau-de-meursault', '04ccfc0de9b8b41946ceb13fdc004d15.png');
...
--
-- Structure de la table `product_category_banner`
--
...
--
-- Contenu de la table `product_category_banner`
--

INSERT INTO `product_category_banner` (`id`, `category_id`, `banner`, `link`) VALUES
(2, 1, 'eb2622336a37aa75600999f6620292d2.jpg', '#'),
(3, 1, '179edc2757699b9912a18fe7db26b00d.jpg', '#');
...
--
-- Index pour la table `product_category_banner`
--
...
--
-- AUTO_INCREMENT pour la table `product_category_banner`
--
ALTER TABLE `product_category_banner`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
-- Contraintes pour la table `product_category_banner`
--
ALTER TABLE `product_category_banner`
