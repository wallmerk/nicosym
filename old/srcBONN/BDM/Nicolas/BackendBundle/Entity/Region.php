 ...
 * @ORM\Entity(repositoryClass="BDM\Nicolas\BackendBundle\Repository\RegionRepository")
 */
class Region
{
    /**
     ...
     */
    private $dataType = 'region';

	/**
	 * @ORM\OneToMany(targetEntity="Product", mappedBy="region")
	 */
	protected $products;
